...
<body>
	...
	<div class="decision">
		<h1>
			<a id="profile" href="profile.jsp" style ="text-decoration: none; color: white; font-family: UL; font-size: 40px;">Profile</a>
			<a id="signout" href="index.jsp" style ="text-decoration: none; color: white; font-family: UL; font-size: 40px;">Sign Out</a>
		</h1>
	</div>
